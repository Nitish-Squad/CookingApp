...
public class GetNearbyPlacesData_Restaurant extends AsyncTask<Object, String, String> {
    ...
    public GetNearbyPlacesData_Restaurant(RestaurantListFragment fragment)
    {
